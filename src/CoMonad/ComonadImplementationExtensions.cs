   ...
   public static  class ComonadImplementationExtensions
    {
        ...
        public static Result<T3> TryResult<T1, T2, T3>(this Func<T1, T2, T3> func, T1 t1, T2 t2)
        {
            try
            {
                T3 t3 = func(t1, t2);
        ...
        public static Result<T4> TryResult<T1, T2, T3, T4>(this Func<T1, T2, T3, T4> func, T1 t1, T2 t2, T3 t3)
        {
            try
            {
                T4 t4 = func(t1, t2, t3);
