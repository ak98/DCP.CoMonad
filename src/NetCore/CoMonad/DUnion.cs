...
namespace CoMonad
{
    ...
    public class DUnion2<T1, T2> : DUnion
    {
        ...
        public DUnion2(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion2(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion2(DUnion2<T1, T2> source)
    ...
    public class DUnion3<T1, T2, T3> : DUnion
    {
        ...
        public DUnion3(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion3(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion3(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion3(DUnion3<T1, T2, T3> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion4<T1, T2, T3, T4> : DUnion
    {
        ...
        public DUnion4(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion4(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion4(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion4(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion4(DUnion4<T1, T2, T3, T4> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion5<T1, T2, T3, T4, T5> : DUnion
    {
        ...
        public DUnion5(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion5(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion5(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion5(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion5(T5 fifthValue)
            : this(5, fifthValue)
        {
        }


        public DUnion5(DUnion5<T1, T2, T3, T4, T5> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion6<T1, T2, T3, T4, T5, T6> : DUnion
    {
        ...
        public DUnion6(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion6(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion6(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion6(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion6(T5 fifthValue)
            : this(5, fifthValue)
        {
        }


        public DUnion6(T6 sixthValue)
            : this(6, sixthValue)
        {
        }


        public DUnion6(DUnion6<T1, T2, T3, T4, T5, T6> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion7<T1, T2, T3, T4, T5, T6, T7> : DUnion
    {
        ...
        public DUnion7(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion7(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion7(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion7(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion7(T5 fifthValue)
            : this(5, fifthValue)
        {
        }


        public DUnion7(T6 sixthValue)
            : this(6, sixthValue)
        {
        }


        public DUnion7(T7 seventhValue)
            : this(7, seventhValue)
        {
        }


        public DUnion7(DUnion7<T1, T2, T3, T4, T5, T6, T7> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion8<T1, T2, T3, T4, T5, T6, T7, T8> : DUnion
    {
        ...
        public DUnion8(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion8(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion8(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion8(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion8(T5 fifthValue)
            : this(5, fifthValue)
        {
        }


        public DUnion8(T6 sixthValue)
            : this(6, sixthValue)
        {
        }


        public DUnion8(T7 seventhValue)
            : this(7, seventhValue)
        {
        }


        public DUnion8(T8 eighthValue)
            : this(8, eighthValue)
        {
        }


        public DUnion8(DUnion8<T1, T2, T3, T4, T5, T6, T7, T8> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
    ...
    public class DUnion9<T1, T2, T3, T4, T5, T6, T7, T8, T9> : DUnion
    {
        ...
        public DUnion9(T1 firstValue)
            : this(1, firstValue)
        {
        }


        public DUnion9(T2 secondValue)
            : this(2, secondValue)
        {
        }


        public DUnion9(T3 thirdValue)
            : this(3, thirdValue)
        {
        }


        public DUnion9(T4 fourthValue)
            : this(4, fourthValue)
        {
        }


        public DUnion9(T5 fifthValue)
            : this(5, fifthValue)
        {
        }


        public DUnion9(T6 sixthValue)
            : this(6, sixthValue)
        {
        }


        public DUnion9(T7 seventhValue)
            : this(7, seventhValue)
        {
        }


        public DUnion9(T8 eighthValue)
            : this(8, eighthValue)
        {
        }


        public DUnion9(T9 ninthValue)
            : this(9, ninthValue)
        {
        }


        public DUnion9(DUnion9<T1, T2, T3, T4, T5, T6, T7, T8, T9> source)
            : this(source.Discriminator, source.CoproductValue)
        {
        }
